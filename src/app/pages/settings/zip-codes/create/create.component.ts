...
export class ZipCodesCreateComponent implements OnInit {
  forma:FormGroup;
  userProfile: any;
  countryList: any [] = [];
  departmentList: any [] = [];
  cityList: any [] = [];
  constructor(private _router: Router, private _localStorage: LocalStorageService, private _countryService: CountryService, private _departmentService: DepartmentService, private _cityService: CityService, private _zipCodeService: ZipCodeService) { 
  ...
  saveChanges() {
    ...
    this._zipCodeService.saveZipCode(this.forma.value)
    .subscribe(result => {
      $('body').loading('stop');
